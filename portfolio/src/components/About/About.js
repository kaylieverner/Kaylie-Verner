...
function About() {
  ...
  return (
    <div className="About">
        ...
        I have a passion for creating human-centric solutions, understanding the 'bigger picture', and approaching challenges with an experimental mindset. 

        Additional interests that help my creativity flow are digital and film photography, hiking, and cooking. 
        </p>
        </div>
    </div>
  );
